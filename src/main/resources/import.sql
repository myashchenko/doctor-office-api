...
insert into passport (id, series, number, date, where_) values ('2', 'НМ', 232433, DATE '2011-11-11', 'Київським РВУМВС України');

insert into address (id, city, street, home_number, apartment_number) values ('1', 'Київ', 'Металістів', 2, 90);
insert into address (id, city, street, home_number, apartment_number) values ('2', 'Київ', 'Металістів', 2, 91);
...
insert into patient (id, first_name, last_name, date_of_birth, gender, doctor_id, passport_id, address_id) values ('2', 'Іван', 'Іванов', '22-11-2000', 'MALE', '1', '2', '2');
